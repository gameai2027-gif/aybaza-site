...
const ours = [
  ...
  "НДС и утильсбор уже в расчёте",
  "Офис в Уфе — можно встретиться",
  "Стоимость фиксируем в договоре",
];
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mb-10">
          <p className="text-sm font-semibold uppercase tracking-wider text-orange-400 mb-3">
            Главный страх при импорте
          </p>
          <h2 id="risk-heading" className="text-3xl sm:text-4xl font-bold tracking-tight text-white">
            «А вдруг доплатят в конце?» — этот риск мы снимаем сразу
          </h2>
          <p className="mt-4 text-slate-400 leading-relaxed">
            Большинство отказываются от импорта из‑за неизвестных доплат.
            Мы показываем полную смету до того, как вы вложите деньги.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-5">
          ...
          <div className="rounded-2xl border border-orange-500/25 bg-orange-500/5 p-6 sm:p-8">
